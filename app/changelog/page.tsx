...
const releases = [
  {
    ...
    changes: [
      { type: "feature", text: "Core CLI: decoy run, validate, demo, storm, plan, init, explain, templates" },
      { type: "feature", text: "Masking: 13 strategies including hash, faker, redact, date_shift, categorical, shuffle, bucketize, fpe, formula, nested, text_redact, passthrough, truncate" },
      ...
      { type: "feature", text: "5 bundled Disguise templates (HIPAA, PCI, GDPR, generate, minimal); pick a template, edit YAML to fit your data" },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "feature", text: "Multi-table pipelines: FK preservation across mask + generate kinds in a single PipelineConfig (FC-1)" },
